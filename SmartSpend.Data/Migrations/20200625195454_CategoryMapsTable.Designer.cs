...
namespace SmartSpend.Data.Migrations
{
    ...
    [Migration("20200625195454_CategoryMapsTable")]
    partial class CategoryMapsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartSpend.Core.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SmartSpend.Core.Models.CategoryMap", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SmartSpend.Core.Models.ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SmartSpend.Core.Models.Split", b =>
                {
                    b.HasOne("SmartSpend.Core.Models.Transaction")
                        .WithMany("Splits")
            ...
            modelBuilder.Entity("SmartSpend.Core.Models.Transaction", b =>
                {
                    b.HasOne("SmartSpend.Core.Models.Account")
